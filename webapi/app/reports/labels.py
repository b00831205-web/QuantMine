...
_LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "fig_ic_series": "Fig 1 · IC time series + rolling mean",
        ...
        "fig_quantile_curve": "Fig 3 · cumulative NAV Q1–Q5 + SPY",
    ...
    "zh": {
        ...
        "col_mono_pos": "日度为正占比",
        "fig_quantile_curve": "图 3 · 分位累计净值 Q1–Q5 + SPY",
